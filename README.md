...
To keep it agile, filling in the necessary information for the first version repository should not take more than ten minutes. 

_Instructions to fill in this file are put in italic. Remove them when filling in the necessary and relevant descriptions_
...
Detailed updates or build instructions are better suited for the subfolders such a `./Docs` or `./Results`.
...
+ Project lead: Sanli Faez @sanlifaez
+ Contributors:
